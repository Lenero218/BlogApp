...
import com.example.bloggingapp.ui.AreYouSureCallback
import com.example.bloggingapp.ui.UIMessage
import com.example.bloggingapp.ui.UIMessageType
import com.example.bloggingapp.ui.main.blog.state.BlogStateEvent
import com.example.bloggingapp.ui.main.blog.viewModels.*
import com.example.bloggingapp.util.DateUtils.Companion.convertLongToStringDate
import com.example.bloggingapp.util.SuccessHandling.Companion.SUCCESS_BLOG_DELETED
...
class ViewBlogFragment : BaseBlogFragment(){
    ...
    fun checkIsAuthorOfBlogPost(){
        ...
        viewModel.setStateEvent(BlogStateEvent.CheckAuthOfBlogPost())
    }
    ...
    fun setBlogProperties(blogPost: BlogPost){
        ...
        blog_update_date.setText(com.example.bloggingapp.util.DateUtils.convertLongToStringDate(blogPost.date_updated))
